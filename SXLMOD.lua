...
local Window = OrionLib:MakeWindow({Name = "SXLMOD", HidePremium = false, SaveConfig = true,IntroText = "SXLMOD", ConfigFolder = "SXLMOD"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "SXLMOD"; Text ="欢迎使用SXLMOD"; Duration = 4; })
...
about:AddParagraph("作者: 海的那边是什么")
about:AddParagraph("作者qq: 477409523")
about:AddParagraph("qq群: 914146161")
...
about:AddParagraph("不能倒卖圈钱")
about:AddParagraph("倒卖没亩没坝")
